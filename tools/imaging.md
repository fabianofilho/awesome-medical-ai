...
- [SimpleITK](https://simpleitk.org/) — Interface simplificada para o Insight Toolkit (ITK).
- [3D Slicer](https://www.slicer.org/) — Plataforma de código aberto para visualização e análise de imagens médicas.
- [OpenNeuro](https://openneuro.org/) — Plataforma de dados de neuroimagem com +1.240 datasets públicos de +51.000 participantes (MRI, PET, MEG, EEG). Segue FAIR e BIDS.
